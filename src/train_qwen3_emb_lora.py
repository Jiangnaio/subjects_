...
outdir = './qwen3-emb-infonce-b8x6-lora48-pos6'
...
CONFIG = {
    ...
    "warmup_ratio": 0.1,
    "output_dir": outdir,
    "dataset_dir": "/media/jh/新加卷/11_15/codes/datasets2",
    ...
    "max_positives": 8,   #8,3 --> 10,5 --> 10,7 --> 10,50(不限制正主题数量)
